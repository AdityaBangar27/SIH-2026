...
audio, sr = sf.read("VaniShiksha/android_ai/samples/sample_audio/test_sentence_6.wav")
...
for step in range(80):
    ...
    print(f"Step {step}: next={next_tok} ({tokenizer.decode([next_tok]) if next_tok < 50257 else 'SPECIAL'})")
    if next_tok == 50257 or next_tok >= 50364:
        print(f"STOPPED at token {next_tok} (step {step})")
        break
